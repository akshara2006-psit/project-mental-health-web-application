...
const stopSessionShowProgress = () => {
    ...
    let videoContent = "good morning lets go dont run walk please thank you look a spider be careful no touch close the door wash your hands good job what do want to drink milk no i water youre welcome what orange juice like all gone more yes can dance good job fantastic is fun it am proud of agree sorry okay where bear thats not there sits cat doll blocks are dog ball roll bathroom here bathtub get into bubbles fun brush good job time for bed see pillow lamp my toy spider nose eyes ears hair turn off light stars clouds raining rain too go to night";
