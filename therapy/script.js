...
const addTherapy = () => {
    // Write code to add new user Therapy 
...
const getTherapies = () => {
    // Write code to get all the therapys of the user
    db.collection('therapy')
...
const editTherapy = (e) => {
    // Write code to update the therapy of a user (e is therapy ID here)
    // Write code to get all the therapies of the user
